...
//
// These settings were last changed with pcb-gcode-setup: 26.09.2016 12.03
//
//
...
int SPOT_DRILL = YES;
real SPOT_DRILL_DEPTH = -0.381000;
...
int PREVIEW_WINDOW_WIDTH = 1920;
int PREVIEW_WINDOW_HEIGHT = 1080;
